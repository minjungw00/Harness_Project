...
| Documentation maintainer / 문서 유지보수자 | [Authoring Guide](en/maintain/authoring-guide.md) -> [Translation Guide](en/maintain/translation-guide.md) -> [Rewrite Plan](en/maintain/rewrite-plan.md) -> [Rewrite Acceptance Review](en/maintain/rewrite-acceptance-review.md), with owner docs only for strict meaning. | [문서 작성 가이드](ko/maintain/authoring-guide.md) -> [번역 가이드](ko/maintain/translation-guide.md) -> [재작성 계획](ko/maintain/rewrite-plan.md) -> [재작성 수락 리뷰](ko/maintain/rewrite-acceptance-review.md), 엄격한 의미 확인에는 owner 문서만. |
