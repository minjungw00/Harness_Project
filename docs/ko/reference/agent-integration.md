...
조건:
- 어떤 역량이 지원된다고 선언되려면 [범위 참조](scope.md)와 영향받는 담당 문서가 그 역량을 활성 또는 프로필 조건부 지원 동작으로 정의해야 합니다.
- 보호된 읽기, 상태 변경, 아티팩트 동작, 보장 표시는 호환되는 활성 접점 맥락과 메서드 담당 문서의 지원이 있을 때만 역량 선언을 사용할 수 있습니다.
...
- 기계 판독용 실패 의미는 [API 오류](api/errors.md)로 보내야 합니다.
