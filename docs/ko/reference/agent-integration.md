...
| 판단 요청 | 현재 판단 참조 또는 후보와 [에이전트 가이드: 판단 요청은 좁고 분명하게](../use/agent-guide.md#5-판단-요청은-좁고-분명하게). |
| 쓰기 준비 | 현재 범위/상태와 [에이전트 가이드: 제품 파일 쓰기 전에 범위 확인](../use/agent-guide.md#6-제품-파일-쓰기-전에-범위-확인), 그리고 의도한 쓰기에 필요한 `prepare_write` 소유자 섹션. |
| 실행 / 증거 | 현재 Run/아티팩트 참조와 [에이전트 가이드: 의미 있는 행동 뒤에는 증거 기록](../use/agent-guide.md#7-의미-있는-행동-뒤에는-증거-기록). |
| 닫기 준비 상태 | 현재 소유자 기록과 [에이전트 가이드: 정직하게 닫기](../use/agent-guide.md#10-정직하게-닫기). |
