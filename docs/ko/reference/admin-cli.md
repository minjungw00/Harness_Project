...
| `host_hook_guarded` | 선택된 프로젝트 로컬 guarded host hook에 검증된 생성 설정, native host output, 필수 lifecycle phase, Bash/shell 및 직접 파일 쓰기 matcher coverage, 일치하는 policy hash, 현재 런타임 guard 관찰이 있습니다. |
