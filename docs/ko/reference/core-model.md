...
| `user_judgment` | 사용자가 소유하는 결정을 위한 기록군입니다. | 호환성에는 반영되지만 그 자체로 활성 범위 변경, 증거 생성, 쓰기 권한 부여, 잔여 위험 수락, Task 닫기를 만들지 않습니다. |
...
담당 문서 링크:
- [Prepare Write 메서드](api/method-prepare-write.md)
- [Record Run 메서드](api/method-record-run.md)
...
| 증거 요약 | 특정 닫기 관련 주장에 대해 기록된 뒷받침, 공백, 참조, 범위 기대치. | 기록되지 않은 동작이 일어났다는 사실, 결과 수락, 잔여 위험 수락. |
...
담당 문서 링크:
- [Close Task 메서드](api/method-close-task.md)
- [API 상태 스키마](api/schema-state.md)
