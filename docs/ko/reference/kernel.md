...
Autonomy Boundary는 Change Unit semantics의 일부입니다. Agent가 추가 user decision 없이 진행할 수 있는 product-judgment 경계를 기록합니다. Goals, scope, design direction, trade-offs, codebase stewardship, 남은 위험, implementation choices에 대해 허용된 latitude를 포함합니다.
...
이 section은 긴 negative boundary 항목을 한곳에 모아, 뒤의 reference sections가 각자의 positive contract에 집중할 수 있게 합니다.
