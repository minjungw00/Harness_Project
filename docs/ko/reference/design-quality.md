...
| 경계 | 규칙 |
|---|---|
| 독립적인 닫기 권한 | 설계 품질 발견 사항은 자동으로 닫기 차단 사유, 닫기 범주, 범위 재정의, 증거 규칙, 보장이 되지 않습니다. |
...
라우팅:
- 해당 계약이 그 좁은 행동을 요구할 때만 조언성 다음 행동, 증거 요청, 집중된 사용자 판단, 잔여 위험 표시를 사용합니다.
...
- 넓은 승인, "좋아 보인다" 같은 말, 일반적인 진행 승인은 관련 계약이 그 특정 판단을 물은 경우가 아니라면 위 판단 중 하나가 아닙니다.
...
조건:
- 해당 계약이 쓰기 안전성, 닫기 준비 상태, 사용자 판단, 잔여 위험, 정직한 보장 표시에 영향을 주는 주장에 뒷받침을 요구합니다.
