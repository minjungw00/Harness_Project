...
|---|---|---|
| `final_acceptance` | 닫기 근거가 보인 뒤 사용자가 결과를 판단한 내용입니다. | 증거 생성, 잔여 위험 수락, QA, 검증, 차단 사유 override. |
...
검증기 ID는 보고용 라벨입니다. Core 불변조건, gate, 닫기 차단 사유, 면제, 증거 기록, 사용자 판단을 만들지 않습니다.
