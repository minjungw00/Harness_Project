...
담당 문서 링크:
- 보안 비주장, 보장 수준, 관찰 경계: [보안](security.md)과 관련 이후 후보 담당 문서.
- 이후 후보의 승격 경계: [이후 후보 색인](../later/index.md).
...
담당 문서 링크:
- 미뤄 둔 후보 이름과 승격 경계: [이후 후보 색인](../later/index.md).
...
이 문서나 연결된 참조 문서를 편집하는 일은 문서 전용 작업입니다.
...
담당 문서 링크:
- 구현 준비 상태와 유지보수자 인계 상태: [MVP 계획](../build/mvp-plan.md). 그 계획이 런타임 작업을 명시적으로 승인하지 않는 한 이 저장소는 문서 전용입니다.
