...
Surface name, connector 구성 메모, friendly mode label, Projection, template, status card, artifact, documentation check는 보장 수준을 올려 주지 않습니다. 더 강한 preventive 또는 isolated claim은 관련 Reference 담당 문서에서 문서화한 mechanism, 대상 동작, 담당 문서, proof path가 필요합니다.
