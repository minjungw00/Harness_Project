...
| 닫기 시도 | `harness.close_task`는 증거, 최종 수락, 잔여 위험, 대체 불가 경계를 유지하면서 닫기 준비 상태를 평가하고 지원되는 닫기 결과를 시도할 수 있습니다. | [Task 닫기 메서드](api/method-close-task.md), [Core 모델](core-model.md), [API 오류 경로](api/error-routing.md) |
