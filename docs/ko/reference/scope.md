...
아래 기능 묶음은 지원되는 기준 범위 밖에 있습니다. 이 범위 참조가 해당 기능을 포함하고 영향받는 현재 담당 문서가 그 동작을 정의할 때만 지원됩니다.
...
- 이 범위 참조와 영향받는 현재 담당 문서가 지원된다고 명시적으로 정의하지 않는 한 제외된 기능은 지원 동작이 아닙니다.
...
지원하려는 기능의 현재 담당 문서가 없다면 지원 기능으로 설명하기 전에 담당 문서를 만들거나 지정해야 합니다. 자리표시자를 현재 담당 문서처럼 독자에게 안내하지 않습니다.
