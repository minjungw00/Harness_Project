...
| `tasks.result` | 영속되는 큰 Task 결과 | [`tasks.result`](#tasksresult) 참고 |
...
- `superseded`는 terminal 상태입니다.

담당 문서 링크:
- [API 값 집합](api/schema-value-sets.md#task-lifecycle-values).
- [API 상태 스키마](api/schema-state.md).
...
담당 문서 링크:
- [아티팩트 저장소](storage-artifacts.md).
- [API 값 집합](api/schema-value-sets.md#record-and-reference-values).
- [Core 모델](core-model.md).
