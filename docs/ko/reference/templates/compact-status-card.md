...
필요한 Decision: {blocking_decision_summary|none}
...
Design/stewardship은 Close status와 별개입니다. Shaping, write blocker, close blocker, Decision Packet 필요성에 영향을 줄 수 있지만 단순한 close-status field가 아닙니다.
