...
Boundary Summary는 Approval 범위, 연결된 Approval 기록, 관련 Decision Packet ref, 현재 쓰기 또는 닫기 context에서 파생한 표시 block입니다. 사용자에게 경계를 상기시키는 용도이며 독립된 권한 source나 gate가 아닙니다.
