...
- 검증, 결과 수락, 닫기 영향 요약
- Manual QA record, QA waiver Decision Packet, Evidence Manifest, Eval, acceptance context, Residual Risk, Artifact refs, redaction state, projection freshness를 위한 compact refs
