...
경계: 이 템플릿은 Run과 증거 참조를 표시할 뿐입니다. 증거 자체, 전체 Evidence Manifest, 검증, 수동 QA, 최종 수락, 잔여 위험 수락, 닫기 준비 상태 권한이 아닙니다.
...
- 증거가 뒷받침하는 수용 기준, 완료 주장, 닫기 관련 주장
...
````text
실행/증거 요약
표시 전용: ref와 요약일 뿐이며 증거, 검증, QA, 최종 수락, 닫기가 아닙니다.
