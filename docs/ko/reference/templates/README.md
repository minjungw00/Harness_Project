...
- 렌더링된 보기는 민감 동작 승인, 최종 수락, 잔여 위험 수락, 근거, 닫기 준비 상태, Write Authorization, close를 만들 수 없습니다.
...
| 닫기 표시 | [닫기 결과](close-result.md) | MVP-1 사용자 작업 루프 | 닫기 준비 상태, 최종 수락, 잔여 위험, 막힘, 가장 작은 해소 방법, 닫기 결과를 보여줍니다. 상세 Journey, direct-result, export, release-handoff report는 later/full-profile입니다. |
