...
단계별 전달 계획에서 user judgment visibility는 status/next responses, judgment-context resources, user-judgment resources, enabled compatibility decision-packet resources, MVP-1 판단 요청 보기로 렌더링합니다. 현재 위치 맥락은 먼저 다섯 가지 작은 MVP 보기로 렌더링합니다.
