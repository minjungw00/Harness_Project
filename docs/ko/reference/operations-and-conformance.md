...
- 향후 fixture의 구조화된 draft body shape나 assertion semantics가 필요할 때. Overview는 여기서 시작하고 core detail과 활성 state-assertion fixture draft는 [Conformance Fixtures 참조](conformance-fixtures.md)를, 간결한 향후 scenario family 목록은 [향후 Fixtures](../later/future-fixtures.md)를 사용합니다.
