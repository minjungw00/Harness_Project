...
| Fixture 작성 순서와 suite coverage | [Conformance staging](#conformance-staging), 그다음 [검증 프로파일별 증명 동작](conformance-fixtures.md#검증-프로파일별-증명-동작), [v0.1 Core Authority Slice Fixture Set](conformance-fixtures.md#v01-core-authority-slice-fixture-set), [v0.2 User-Facing Harness MVP Fixture Set](conformance-fixtures.md#v02-user-facing-harness-mvp-fixture-set), [Clarification Quality Fixture Group](conformance-fixtures.md#clarification-quality-fixture-group), [커널 스모크(Kernel Smoke) Authoring Queue](conformance-fixtures.md#kernel-smoke-authoring-queue), [향후 Fixture Catalog: Fixture Suites](future-fixture-catalog.md#fixture-suites) | Kernel gate와 event name은 [커널 참조](kernel.md)에 남습니다. Future catalog suite는 listing만으로 early-stage requirement가 되지 않습니다. |
...
사용자 대상 하네스 MVP(v0.2 User-Facing Harness MVP)는 [Conformance Fixtures 참조](conformance-fixtures.md#v02-user-facing-harness-mvp-fixture-set)의 작은 user-value fixture set과 [Clarification Quality Fixture Group](conformance-fixtures.md#clarification-quality-fixture-group)을 사용합니다. v0.2는 broad future catalog, full Manual QA, Eval systems, TDD trace, module map, interface contract, Journey/Spine projection, export/recover, dashboard/team/orchestration, advanced connector/security fixture를 실행해야 하는 단계가 아닙니다.
...
| Suite intent와 작성 순서 | [Conformance staging](#conformance-staging), 그다음 [검증 프로파일별 증명 동작](conformance-fixtures.md#검증-프로파일별-증명-동작), [v0.1 Core Authority Slice Fixture Set](conformance-fixtures.md#v01-core-authority-slice-fixture-set), [v0.2 User-Facing Harness MVP Fixture Set](conformance-fixtures.md#v02-user-facing-harness-mvp-fixture-set), [Clarification Quality Fixture Group](conformance-fixtures.md#clarification-quality-fixture-group), [커널 스모크(Kernel Smoke) Authoring Queue](conformance-fixtures.md#kernel-smoke-authoring-queue), [향후 Fixture Catalog: Fixture Suites](future-fixture-catalog.md#fixture-suites) |
