...
| 거부 응답, 차단 결과, `dry_run` 미리보기 | [API 오류 경로](error-routing.md) |
| 닫기 준비 상태 blocker 처리 경로, 금지된 공개 오류의 blocker 표현, `close_task` blocker 매핑 | [API blocker 처리 경로](blocker-routing.md) |
