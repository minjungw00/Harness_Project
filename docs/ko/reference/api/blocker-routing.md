...
| 범위, 사용자 소유 판단, 민감 동작 승인, connection capability | 차단 사유 범주가 붙은 데이터는 닫기가 사용자, 범위, 민감 동작 승인, connection capability 담당 문서에 의존함을 보여 줄 수 있습니다. | 차단 사유는 사용자 결정, 민감 동작 승인, 범위 변경, 역량 선언을 기록하지 않습니다. |
...
- 최종 수락 또는 잔여 위험 수락
- 사용자 소유 판단, 민감 동작 승인, `Write Check`
- 증거 충분성 또는 아티팩트 가용성
- 닫기 완료 또는 종료 `Task` 상태
