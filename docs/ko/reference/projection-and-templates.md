...
- 이 에이전트용 패킷은 `change_unit_ref`, `autonomy_boundary`, `close_blockers`, `guarantee_level` 같은 기계 판독용 필드 이름을 유지할 수 있습니다. 이런 이름을 사용자용 카드의 표시 라벨로 다시 쓰면 안 됩니다.
