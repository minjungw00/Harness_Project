...
|---|---|---|
| Spec Compliance Review | 현재 Harness 권한 안에서 요청된 Task를 만족했는가? | acceptance criteria 충족 범위, Change Unit 완료 조건, scope 및 Write Authority 호환성, Decision Packet 호환성, 근거 범위, Residual Risk 표시. |
