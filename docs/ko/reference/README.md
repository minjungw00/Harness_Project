...
| 메서드별 응답 분기 스키마는 어느 담당 문서가 맡나요? | `api/schema-core.md` |
...
| API 예시 정합성 질문은 어디로 보내나요? | `../maintain/authoring-guide.md`, `../maintain/checks.md`, 그다음 영향을 받는 메서드 또는 스키마 담당 문서 |
| 필드 이름 일관성 질문은 어디로 보내나요? | `../maintain/authoring-guide.md`, `../maintain/checks.md`, 그다음 영향을 받는 메서드, 스키마, 또는 저장소 담당 문서 |
| 활성 API 메서드 목록은 어느 담당 문서가 맡나요? | `api/mvp-api.md` |
| 정확한 API 메서드 이름 값은 어느 담당 문서가 맡나요? | `api/schema-value-sets.md` |
| 메서드 페이로드 필드 질문은 어디로 보내나요? | 영향을 받는 [API 메서드 담당 문서](#api-메서드-담당-문서), 또는 공통 요청 래퍼와 중첩 필드의 스키마 담당 문서 |
...
| `harness.record_run` 증거 동작은 어느 담당 문서가 맡나요? | `api/method-record-run.md`, `storage-effects.md` |
