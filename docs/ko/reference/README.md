...
- 사용자 또는 에이전트 동작 문구: [사용자 가이드](../use/user-guide.md)나 [에이전트 가이드](../use/agent-guide.md)에서 시작합니다. 보이는 막힘, 판단, 쓰기 전 확인, 근거 공백, 닫기 결과, connector behavior의 정확한 근거가 필요할 때만 Reference를 사용합니다.
