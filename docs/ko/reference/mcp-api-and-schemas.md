...
Core unavailable, local access denied, stale state, unsupported surface, 범위 밖 작업, 필요한 사용자 판단, 부족한 증거, 닫기 차단 사유, 잔여 위험 있음의 동작은 [API Errors: MVP-1 guarantee와 상태/error taxonomy](api/errors.md#mvp-1-guarantee-and-status-taxonomy)가 담당합니다.
