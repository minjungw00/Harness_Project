...
| `effect_kind` | 응답의 상태 효과를 분류하는 필드입니다. 활성 값은 읽기 전용 결과, Core 커밋, 임시 스테이징, 상태 효과 없음 분기를 나누며, 메서드별 상태 효과는 MVP API가 담당합니다. | [API Schema Core](api/schema-core.md), [MVP API](api/mvp-api.md) |
