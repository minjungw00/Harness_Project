...
이 문서에서는 일부러 개념을 작게 다룹니다. 재설계 중 엄밀한 정의의 현재 담당 문서는 `reference/kernel.md`에 대해서는 [커널 명세](../03-kernel-spec.md), `reference/mcp-api-and-schemas.md`에 대해서는 [MCP API와 스키마](../05-mcp-api-and-schemas.md), `reference/document-projection.md`에 대해서는 [문서 Projection](../07-document-projection.md)입니다.
...
현재 담당 문서: [커널 명세](../03-kernel-spec.md). 이후 reference 경로: `reference/kernel.md`.
