...
Decision Packet은 사용자가 해야 하는 결정이 진행, 쓰기, 닫기, 예외 허용, 수용, 남은 위험 수용, 제품 방향, 중요한 기술 방향, 범위, 설계 절충, 코드베이스 돌봄 판단, 공개 약속을 막을 때 기록하는 묶음입니다. 필요한 결정, 선택지, 장단점, 근거, 영향을 받는 범위, 남은 위험, 다음 행동을 적습니다.
