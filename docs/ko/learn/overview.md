...
하네스는 대화 기록을 진실의 기준으로 삼지 않습니다. 생성된 Markdown을 운영 기록으로 삼지도 않습니다. 대화는 대화입니다. Markdown 읽기용 요약은 사람이 읽는 보기입니다. Core가 소유한 로컬 상태와 아티팩트 참조가 운영상 기준입니다. 목표, 범위, 설계 판단, 제품 판단과 기술 구조 판단, QA 판단, 작업 수락, 잔여 위험 수용은 여전히 사용자가 합니다.
