...
Markdown 보고서는 이런 evidence를 보여주는 유용한 view이지, evidence나 상태 기록 그 자체가 아닙니다. 보고서를 편집한다면 사람이 적는 note 또는 proposal 영역을 사용합니다. Generated 또는 managed report text를 직접 고친 내용은 gate 변경이 아니라 drift 또는 reconcile input으로 다뤄져야 합니다.
