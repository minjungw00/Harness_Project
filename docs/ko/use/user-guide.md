...
에이전트가 이 말을 필요한 Harness 절차로 바꿔야 합니다. 사용자가 내부 기록을 직접 조작할 필요는 없습니다.
...
사용자는 평소처럼 말하면 됩니다. 에이전트가 그 요청을 알맞은 Harness 흐름으로 바꿔야 합니다.
