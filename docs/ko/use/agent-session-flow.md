...
- 보장 수준(guarantee level)과 접점이 실제로 막을 수 있는 것 또는 감지만 할 수 있는 것. 이는 approval, verification, acceptance, gate가 아니라 표시와 risk context입니다.
