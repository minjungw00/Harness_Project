...
Discovery 결과는 Shared Design, 결정 패킷 candidate, Change Unit shaping으로 라우팅합니다. Discovery Brief, Question Queue, Assumption Register, First Safe Change Unit Candidate를 scope authority, sensitive-action Approval, 작업 수락, 잔여 위험을 받아들이는 판단, evidence, 닫기 준비 상태, 쓰기 허가 기록으로 취급하지 않습니다.
