...
`volicord-mcp`를 찾은 뒤 설치 프로필을 저장합니다. MCP 명령 찾기는 명시적
...
Runtime Home, 설치 프로필, 저장된 명령 경로, 적용되는 명령 링크를 사용할 수 있으면
...
해석된 Runtime Home에 저장된 설치 프로필을 사용하며 MCP 명령 경로, Runtime Home
