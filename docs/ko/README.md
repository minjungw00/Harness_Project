...
- 문서 유지보수자: [문서 정책](maintain/documentation-policy.md), [번역 정책](maintain/translation-policy.md), [검증](maintain/validation.md), [doc-index.yaml](../doc-index.yaml), [용어 지도](../terminology-map.yaml)를 사용합니다.
