...
이 문서는 현재 하네스 문서 기준선에 대한 최종 문서 재설계 수락 리뷰입니다. Maintainer 인계를 위한 Maintain 문서입니다.
...
상태: 부분 점검만 수행됨. Full validation pass로 취급하면 안 됩니다.
...
- Full relative link와 anchor checker.
- Mermaid parser 또는 renderer.
...
- Full link/anchor, Mermaid syntax, full bilingual semantic check는 이 리뷰 batch에서 실행하지 않았습니다.
