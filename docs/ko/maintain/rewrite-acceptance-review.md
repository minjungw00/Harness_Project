...
- Core Model canonical-schema bullet wording은 이 대상 리뷰 note 이후 정규화되었습니다. 더 넓은 acceptance status를 새로 고친 것은 아닙니다.
