...
사용 문서와 참조 담당 문서가 다르게 보이면 권한은 참조 담당 문서에 있습니다. 경로나 가이드의 불일치는 문서 유지보수 작업입니다.

## 지원 범위 밖 동작

이름이 있는 기능도 기준 범위 지원 밖에 남아 있을 수 있습니다. 그 기능이 기준 범위 동작이 되는 시점은 범위 문서와 영향받는 담당 문서가 정합니다.

그 담당 문서 작업이 있기 전까지 이 가이드는 질문을 [범위](../reference/scope.md)와 영향받는 담당 문서로 되돌려 보낼 뿐입니다. 세부 처리는 이 가이드가 아니라 해당 담당 문서에서 정의합니다.
