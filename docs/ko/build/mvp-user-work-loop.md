...
Build staging 자체가 security guarantee를 올려 주지는 않습니다. Security wording은 [보안 위협 모델의 단계별 guarantee level](../reference/security.md#단계별-guarantee-level)을 따릅니다.
