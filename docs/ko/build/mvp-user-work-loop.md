...
> 사용자가 평소 말로 작업을 시작하거나 이어갈 때, 하네스는 범위, 대기 중인 사용자 판단, 근거 요약, 닫기 막힘, 다음 안전한 행동, 최종 수락, 잔여 위험 표시의 로컬 근거를 보존한다.
