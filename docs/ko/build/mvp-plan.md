...
| Future fixture/conformance와 operations material | [Conformance Fixtures 참조](../reference/conformance-fixtures.md), [향후 Fixtures](../later/index.md#future-fixture-families), [운영과 Conformance 참조](../reference/operations-and-conformance.md). |
