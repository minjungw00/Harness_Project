...
- export
- artifact 무결성 확인
- state, events, artifacts, projections, errors를 대상으로 하는 fixture 기반 conformance smoke
...
|---|---|
| MVP-0 | Doctor/readiness가 runtime home, 등록된 project, artifact store, 기준 agent 접점, idle state를 보여 줄 수 있습니다. |
