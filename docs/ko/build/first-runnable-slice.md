...
Owner contract: runtime home layout과 내부 엔지니어링 점검에서 사용하는 내부 엔지니어링 점검 schema는 [Storage와 DDL](../reference/storage-and-ddl.md#core-authority-smoke-schema)이 담당합니다. Local space와 guarantee-level placement는 [런타임 아키텍처 참조](../reference/runtime-architecture.md)가 담당하고, guarantee-level 의미는 [보안 위협 모델 참조](../reference/security-threat-model.md#정직한-guarantee-display)가 담당하며, connector reporting은 [Agent 통합 참조](../reference/agent-integration.md)가 담당합니다.
