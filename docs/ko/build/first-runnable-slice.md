...
이 흐름을 통과하면 코어 권한 조각(v0.1 Core Authority Slice)이 동작한다는 뜻입니다. 사용자가 Harness MVP를 경험했다는 뜻은 아닙니다. 사용자 대상 MVP는 평범한 요청이 범위, 사용자 소유 판단, 근거, 닫기 준비 상태, 작업 수락, 잔여 위험 언어로 정리될 때 시작됩니다.
