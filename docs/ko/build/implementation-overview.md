...
- 제품 명제: 하네스는 범위, 사용자 소유 판단, 근거, 검증 기대, QA 기대, 작업 수락, 잔여 위험, 닫기 준비 상태를 위한 로컬 기준 기록입니다.
...
| Storage | 권한 루프에 필요한 owner-approved 최소 persistence만 사용합니다. | MVP-1 user judgment, evidence summary, blocker, compact output에 필요한 storage만 더합니다. | [Storage](../reference/storage.md). |
