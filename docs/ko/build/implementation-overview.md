...
Build는 단계 경계와 읽기 경로를 담당합니다. 정확한 public method 계약은 [MVP API](../reference/api/mvp-api.md), shared shape는 [API Schema Core](../reference/api/schema-core.md), 작은 view/template 계약은 [Projection과 Template 참조](../reference/projection-and-templates.md)와 [Template 참조](../reference/templates/README.md)가 담당합니다. 활성 MVP-1 method와 작은 출력 목록은 [MVP-1 사용자 작업 루프](mvp-user-work-loop.md#핵심-생각)에 중앙화합니다.
