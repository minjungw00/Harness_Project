...
The active user path is a focused judgment request through `user_judgment`. A full-format Decision Packet is later candidate presentation material for complex judgments. Users should not need that label to answer ordinary prompts.
