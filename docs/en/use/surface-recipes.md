...
An IDE/editor surface should keep the editing boundary close to the edit workflow without claiming that the editor prevents every unsafe action.
...
- Keep product, UX, accessibility, security, dependency, data-shape, final-acceptance, and residual-risk decisions separate from editor convenience prompts.
