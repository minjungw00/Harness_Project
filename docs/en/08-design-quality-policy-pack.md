...
| `required_record` | Task or Change Unit feedback-loop fields, selected-loop refs, validator results, `tdd_traces` when TDD is selected, Manual QA record when Manual QA is selected, and evidence manifest refs when executed. |
