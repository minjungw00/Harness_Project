...
- stale route wording, broken links, anchors, and README routes
...
## 3. Stale Route Wording Check

Inspect relative Markdown links, README routes, paired-language links, owner links, heading anchors, old path names, deleted route names, legacy document families, and old structure labels.

Pass when every active link resolves to a current compact route and current anchor. Fail when active docs point to a deleted file, old heading, inactive migration record, wrong-language owner, stale route family, or old structure name.

## 4. Bilingual Semantic Parity Check
...
## 7. Active/Profile-Gated Value Check
...
## 8. Unsupported Security Claim Check
...
## 9. User Judgment Boundary Check
...
## 10. Projection-Derived-Display Check
...
## 11. One-Language-Per-`doc_id` Agent Retrieval Check
