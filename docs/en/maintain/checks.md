...
| [API examples checks](checks/api-examples.md) | durable self-contained scenarios, field-name consistency, response snapshot consistency, refs, timestamps, no fixed shared sample task requirement, and API owner routing in examples |
