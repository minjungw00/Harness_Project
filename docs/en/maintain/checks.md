...
| [Language parity checks](checks/language-parity.md) | English/Korean semantic, semantic-strength, semantic skeleton, negative-clause, heading, table, and list parity, removed-concept translation residue, identifier preservation, Korean structure, Korean technical style, and nonliteral Korean prose |
