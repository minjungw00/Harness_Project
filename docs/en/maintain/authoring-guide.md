...
| Practical user-owned judgment examples and user-facing judgment request patterns | `use/decision-packet-cookbook.md` for examples; `reference/kernel.md` and `reference/mcp-api-and-schemas.md` for exact user judgment behavior |
