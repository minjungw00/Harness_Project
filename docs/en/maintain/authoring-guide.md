...
| Judgment terminology reintroduces legacy aliases as current axes. | Active owner docs prefer `UserJudgment` / `user_judgment`, `harness.request_user_judgment`, `judgment_kind`, `presentation`, and `display_label`; legacy aliases stay compatibility-only. | Schema/design decision |
