...
| Compact future scenario-family inventory, promotion criteria, suite-family labels, catalog-only future candidates outside the MVP path | `later/index.md#future-fixture-families` |
