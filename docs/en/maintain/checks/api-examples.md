...
- A single broad API error page is treated as the owner for separate error-code, precedence, response branch routing, close-readiness blocker routing, and details concerns.
