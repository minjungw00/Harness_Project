...
- For API error concepts, route public code meanings to [API error codes](../../reference/api/error-codes.md), precedence and conflicts to [API error precedence](../../reference/api/error-precedence.md), response branch routing to [API error routing](../../reference/api/error-routing.md), close-readiness blocker routing to [API blocker routing](../../reference/api/blocker-routing.md), and machine-readable details to [API error details](../../reference/api/error-details.md).
