...
| Which public errors or close-readiness blocker routes are valid? | [API Errors](../reference/api/errors.md), [API Error Codes](../reference/api/error-codes.md), [API Error Precedence](../reference/api/error-precedence.md), [API Error Routing](../reference/api/error-routing.md), [API Error Details](../reference/api/error-details.md), plus the relevant method and state-schema owners |
