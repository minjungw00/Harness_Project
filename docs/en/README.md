...
This is the English entry point for the Harness documentation set. Use it to choose a reading path; owner documents define the detailed reference material.

## Reading Paths

- New user: [Start](start.md), then [User Guide](use/user-guide.md).
...
- Use the [Reference Index](reference/README.md) to find API, schema, storage, security, scope, projection, and close-readiness owner documents.
- Use [doc-index.yaml](../doc-index.yaml) when you need stable `doc_id` routing metadata.
