...
Direct work may close self-checked by default unless policy or the user requires detached verification or other gates. A consumed Write Authorization ref may be displayed, but the projection does not become the canonical authorization record. An attempted invalid authorization ref must be displayed only as violation/audit or validator-finding context, not as a consumed Write Authorization or completion evidence.
