...
Implementation tier: Future/diagnostic projections. Use this for detailed Evaluation records in later verification profiles; compact verification display can use the card shape.
