...
Implementation tier: Agency assurance reports. Render only when a Manual QA record or active QA profile exists; it is not part of the minimum user-facing MVP output set.
