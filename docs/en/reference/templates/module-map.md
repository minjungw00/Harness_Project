...
Implementation tier: future / diagnostic. Module Map output is a later stewardship/reference view, not required for the first runnable slice or MVP minimum.
