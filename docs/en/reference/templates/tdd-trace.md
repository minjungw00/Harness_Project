...
Implementation tier: Future/diagnostic projections. TDD Trace output is for later policy or diagnostic profiles and must not inflate the first implementation.
