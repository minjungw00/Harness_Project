...
Implementation tier: future / diagnostic. Standalone design projection is later-profile scope; early user decision context can appear in the user decision request display.
