...
Implementation tier: Assurance Profile reports. `APR` is used only after committed sensitive-action Approval support is active; it is not part of Engineering Checkpoint or the MVP-1 compact-card MVP.
