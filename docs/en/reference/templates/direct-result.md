...
Implementation tier: User-facing MVP summaries. Use as an optional compact direct-work result display when that profile is active; it is not required for the first kernel proof.
