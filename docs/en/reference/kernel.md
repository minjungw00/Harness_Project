...
`decision_gate` does not replace scope confirmation, sensitive-action Approval, design policy, evidence, verification, Manual QA, acceptance, or residual-risk acceptance.
