...
flowchart TD
  ...
  Boundary --> UserJudgment["requires user judgment: product/technical direction, risk acceptance, public/module commitments, material migration/dependency direction, policy waivers"]
