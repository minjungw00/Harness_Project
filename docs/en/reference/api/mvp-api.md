...
Method owner examples use a durable account export confirmation scenario: the Task summary is account export confirmation, scope includes the account export confirmation UI and account export tests, account deletion behavior and billing export behavior stay out of scope, and acceptance requires explicit confirmation before download. Other method examples may extend that same scenario with account export tests and representative run and evidence data.
