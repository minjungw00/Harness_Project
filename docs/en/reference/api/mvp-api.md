...
| 6 | `write_compatibility` | `WRITE_AUTHORIZATION_REQUIRED`, `WRITE_AUTHORIZATION_INVALID`, `SCOPE_VIOLATION`, or `BASELINE_STALE` for missing or incompatible Write Authorization, product-write Run, paths, baseline, or observed write. |
