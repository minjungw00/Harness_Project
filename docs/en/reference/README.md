...
| Public `ErrorCode` contract, error precedence, local surface errors, `STATE_VERSION_CONFLICT`, blocked/dry-run response semantics, and public error mapping for `close_task` blockers | [api/errors.md](api/errors.md) |
