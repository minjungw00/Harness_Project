...
use volicord_types::{
    ...
    EvidenceUpdateProvenance, GuaranteeDisplay, GuardConfigurationStatus, GuardEffectiveStatus,
    GuardHealthSummary, GuardInstallationId, GuardInstallationStatus, GuardMode,
    GuardObservationStatus, GuardStrength, JsonObject, JudgmentBasis,
    ...
    RunSummary, SensitiveActionRequirement, SessionWatchStatus, StageArtifactRequest,
    StageArtifactResult, StagedArtifactHandle, StagedArtifactHandleId, StateRecordKind,
    StateRecordRef, StatusCloseState, StatusInclude, StatusRequest, StorageRef, TaskId,
...
use crate::policy::{
    close_readiness::{
        ...
        run_record_matches_close_basis_context, verified_user_channel_provenance,
        CancellationAuthorityRequirement, JudgmentAuthority, ScopeDecisionAuthorityRequirement,
    },
...
fn allocate_user_judgment_id(
    service: &CoreService,
    store: &CoreProjectStore,
) -> CoreResult<volicord_types::UserJudgmentId> {
    service
