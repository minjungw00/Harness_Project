...
- For detailed guidance, use [User Guide](docs/en/use/user-guide.md), [Agent Guide](docs/en/use/agent-guide.md), and [Agent Integration Reference](docs/en/reference/agent-integration.md). For docs edits, use [Authoring Guide](docs/en/maintain/authoring-guide.md).
